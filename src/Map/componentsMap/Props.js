...
export function Props() {
  ...
  const positionArbre1 = {pos :[[1, 1, 10], [10, 10, 10]]}; 
  const testP = [[-7, 1.5, 0], [-6, 3, 0]];
  const testR = [[0, 2, 0], [0, 1.5, 0]];


  return <>

  <Prop file={"voiture/voiture.gltf"} position={[-7, 1.5, 0]} scale={0.25} rotation={[0, 2, 0]} />,

  {/* <Prop file={"tree/2/tree1.gltf"} position={positionArbre1} scale={0.25} rotation={[0.15, 0.4, 0]} />, */}
  ...
  {  /* Ambila lemaitso
   ...
   <Prop file={"passage/passage_voiture.gltf"} position={[45, 2, -2]} scale={0.25} rotation={[0.15, -0.5, 0]} />,
    ...
    <Prop file={"bridge/bridge.gltf"} position={[5, 0.8, 65]} scale={0.4} rotation={[0, -0.95, 0]} />,
     ...
     Alaotra
    <Prop file={"pirogue3/pirogue3.gltf"} position={[-8, 1, 30]} scale={0.3} rotation={[0.15, -0.5, 0]} />,
    ...
    // Ikopa / Anosizato 
   <Prop file={"pirogue3/pirogue3.gltf"} position={[37, 4, 12]} scale={0.4} rotation={[0.15, -0.5, 0]} />,
...
// <Prop file={"duck/3/duck3.gltf"} position={[1, 1, 10]} scale={0.25} rotation={[0.15, -0.5, 0]} />,
   // <Prop file={"duck/4/duck4.gltf"} position={[1, 1, 10]} scale={0.25} rotation={[0.15, -0.5, 0]} />,
    ...
    <Prop file={"pirogue2/pirogue2.gltf"} position={[48, 0.2, -39]} scale={0.3} rotation={[0, 0.2, 0]} />,
   ...
   <Prop file={"eau/2/eau2.gltf"} position={[37, 4, 10]} scale={0.2} rotation={[0.15, -0.5, 0]} />,
    ...
    <Prop file={"pirogue/pirogue.gltf"} position={[-8, 0.5, 30]} scale={0.3} rotation={[0.15, -0.5, 0]} />,
